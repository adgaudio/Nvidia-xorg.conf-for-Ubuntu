> There's a lot of stuff on the web about how to setup your nvidia card
...
[here](http://github.com/adgaudio/Nvidia-xorg.conf-for-Ubuntu/blob/master/xorg.conf_nvidia_without_dualmonitor)
...
- If you want dual monitors, I HIGHLY recommend
  [disper](https://launchpad.net/~disper-dev/+archive/ppa).
